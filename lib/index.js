...
module.exports = {
    ...
    rules: {
        ...
        'jsdoc/check-examples': 'off', // Off for eslint 8 support https://github.com/gajus/eslint-plugin-jsdoc/issues/829
        ...
        'unicorn/no-null': 'off',
        'unicorn/no-thenable': 'off', // This only gives false positives for Joi schemas atm
